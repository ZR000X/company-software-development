---
title: Time and Activity Reporting
aliases:
...
status: draft
description: >-
  Capacity and activity concentration reporting from Time Entry data; feeds talent pipeline insights.
---
...
- [Time Entry](../entities/time-entry.md) data exists (from [Main workflow](./main-workflow.md)), with intervals **closed** (`endAt` set) for accurate aggregates.
...
- [Main workflow](./main-workflow.md) — source of [Time Entry](../entities/time-entry.md) data (open rows must be closed for reporting).
- [Activity Catalogue and Skill Mapping](./to-do/activity-catalogue-and-skill-mapping.md) — optional; required for skill-level insights and linking activity concentration to skills for talent pipeline.
