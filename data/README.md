...
| File | Describes |
| ---- | --------- |
| [work-items.md](work-items.md) | `JIRATickets` logical model (JIRA keys in `Ticket_Number`); used in [Workstream management](../processes/workstream-management.md) and for key semantics in [Data fix workflow](../processes/data-fix-workflow.md). |
